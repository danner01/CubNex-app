...
class DeliveryHubOrdersView extends StatefulWidget {
  const DeliveryHubOrdersView({required this.section, super.key});

  final DeliveryHubSection section;

  @override
  State<DeliveryHubOrdersView> createState() => _DeliveryHubOrdersViewState();
}

class _DeliveryHubOrdersViewState extends State<DeliveryHubOrdersView> {
...
class DeliveryOrderCard extends StatelessWidget {
  const DeliveryOrderCard({required this.order, super.key});
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                DeliveryMetaChip(icon: Icons.payments_outlined, label: total),
                if (order.tarifaCobrada != null)
                  DeliveryMetaChip(
                    icon: Icons.savings_outlined,
                    label:
                        'Tarifa cobrada: ${formatDeliveryMoney(order.tarifaCobrada, order.currency ?? 'CUP')}',
                  ),
                DeliveryMetaChip(
